...
MapShader::MapShader(ID3D11Device* device, ID3D11DeviceContext* context) : Shader(device, context)
{
	m_sampleState = 0;
}
MapShader::~MapShader()
...
bool MapShader::Render(Quad* q, XMMATRIX view, XMMATRIX ortho)
{
	HRESULT result;
